...
const benchmarkBook = {
  ...
  runs: [
    {
      id: 'r1', name: 'Lượt đi', roundNumber: 1, startPoint: 'DG1', mode: 'single',
      stations: [
    ...
    {
      id: 'r2', name: 'Lượt về', roundNumber: 2, startPoint: 'DG2', mode: 'single',
      stations: [
...
async function responsiveChecks(browser) {
  const checks = [];
  for (const [width, height] of [[360, 800], [375, 812], [412, 915], [1280, 900]]) {
